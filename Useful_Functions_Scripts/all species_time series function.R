...
#   
#   Args:
#   startdate = the start date of the period to be ploted. In the form as "2014-01-01" 
#   enddate = the end date of the period to be ploted. In the form as "2014-01-01" 
